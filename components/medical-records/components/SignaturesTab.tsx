...
import { CheckCircle2, Clock, FileSignature, PenTool } from 'lucide-react'
...
export function SignaturesTab({ record, onRefresh }: SignaturesTabProps) {
            ...
            <CardContent>
              {hasSpecialistSignature ? (
                ...
                <div className="space-y-3">
                  ...
                  <Button
                    onClick={() => setIsSpecialistSignatureOpen(true)}
                    className="w-full"
                  >
                    <PenTool className="w-4 h-4 mr-2" />
                    Firmar como especialista
                  </Button>
                </div>
              )}
            </CardContent>
