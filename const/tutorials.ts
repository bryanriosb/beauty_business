...
export const TUTORIALS: Record<string, Tutorial> = {
  'appointment-start': {
    ...
    steps: [
      ...
      {
        target: '[data-tutorial="appointment-specialist-select"]',
        content: 'Selecciona al especialista que atenderá esta cita.',
        title: 'Especialista para la Cita',
        placement: 'top',
        disableBeacon: true,
        showProgress: true,
        showSkipButton: true,
      ...
      {
        target: '[data-tutorial="appointment-features"]',
        content: 'Funcionalidades premium: Recordatorios automáticos, notificaciones WhatsApp, gestión de inventario, comisiones, y más.',
