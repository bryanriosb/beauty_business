...
export function WhatsAppConversationList({ businessAccountId, businessId }: WhatsAppConversationListProps) {
  ...
  const filteredConversations = conversations.filter((conv) => {
    ...
    return conv.phone.toLowerCase().includes(searchQuery.toLowerCase())
  })
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2 mb-1">
                      <h3 className="font-semibold text-sm truncate">{conv.phone}</h3>
                    ...
                    <div className="flex items-center justify-between gap-2">
                      <p className="text-sm text-muted-foreground truncate">
                        {conv.lastMessage.direction === 'outbound' && (
                          <span className="mr-1">{getStatusIcon(conv.lastMessage.status)}</span>
                        )}
