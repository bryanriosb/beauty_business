...
import { exportServicesReportAction, type ExportFormat } from '@/lib/actions/report-export'
...
export function ServicesReport({ businessId, startDate, endDate }: ServicesReportProps) {
              ...
              <TableBody>
                {services.map((s, index) => (
                  <TableRow key={s.service_id}>
                    ...
                    <TableCell className="text-right">{s.total_bookings}</TableCell>
