...
import { HourlyDistributionChart, DailyDistributionChart } from './charts/DistributionChart'
import { ExportButton } from './ExportButton'
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card'
import { Progress } from '@/components/ui/progress'
import ReportsService from '@/lib/services/reports/reports-service'
import { exportAppointmentsReportAction, type ExportFormat } from '@/lib/actions/report-export'
import type { RevenueData, HourlyDistribution, DailyDistribution } from '@/lib/actions/reports'
...
export function AppointmentsReport({ businessId, startDate, endDate }: AppointmentsReportProps) {
      ...
      <Card className="border">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Progress value={cancelledRate} className="h-2 bg-gray-100 [&>div]:bg-orange-500" />
          </div>
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
            ...
            <Progress value={noShowRate} className="h-2 bg-gray-100 [&>div]:bg-red-500" />
          </div>
        </CardContent>
      </Card>
